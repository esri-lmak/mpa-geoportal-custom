...
function (t, e, l, n, o) {
    var r = t([n], {
        ...
        getAllowPullItem: function () {
            return !!this.getItem() && this.allowPullItem
        },
        ...
        getItemFolderId: function () {
            var t = this.getItem();
            return t ? void 0 === t.folderId ? null : t.folderId : null
        },
        getItemId: function () {
            var t = this.getItem();
            return t ? void 0 === t.id ? null : t.id : null
        },
        getItemOwner: function () {
            var t = this.getItem();
            return t ? void 0 === t.owner ? null : t.owner : null
        },
    ...
    return l("extend-esri") && e.setObject("dijit.metadata.arcgis.portal.PortalItemContext", r, o), r
});