...
G.evaluators.geospatialsg = {

    version: "geospatial-sg.v1",
    ...
    evalBase: function (task) {
        ...
        /* general */
        G.evalProp(task, item, root, "fileid", "geoSG:fileIdentifier/*/text()");
        ...
        G.evalProp(task, item, iden, "sys_metadatatype_s", "geospatial-sg");
        ...
        G.evalProps(task, item, root, "data_theme", "geoSG:dataTheme/@codeListValue");
        G.evalProps(task, item, root, "marine_data_theme_level_1", "geoSG:marineDataThemeLevel1/@codeListValue");
        G.evalProps(task, item, root, "marine_data_theme_level_2", "geoSG:marineDataThemeLevel2/@codeListValue");
        G.evalProps(task, item, root, "marine_data_theme_level_3", "geoSG:marineDataThemeLevel3/@codeListValue");
        ...
        /* identification */
        G.evalProp(task, item, root, "apiso_Identifier_s", "geoSG:fileIdentifier/*/text()");
        ...
        /* dates */
        G.evalDate(task, item, root, "apiso_Modified_dt", "geoSG:metadataDateStamp/gco:Date | geoSG:metadataDateStamp/gco:DateTime");
        G.evalDate(task, item, iden, "apiso_CreationDate_dt", "geoSG:metadataCreatedDate/gco:Date | geoSG:metadataCreatedDate/gco:DateTime");
        G.evalDate(task, item, root, "apiso_LastUpdated_dt", "geoSG:metadataLastUpdatedDate/gco:Date | geoSG:metadataLastUpdatedDate/gco:DateTime");
        G.evalDate(task, item, iden, "apiso_DataLastUploaded_dt", "geoSG:dataLastUpdatedDate/gco:Date | geoSG:dataLastUpdatedDate/gco:DateTime");
        ...
        /* language */
        G.evalCode(task, item, root, "apiso_Language_s", "geoSG:language/*/text()");
        G.evalCode(task, item, iden, "apiso_ResourceLanguage_s", "geoSG:language/*/text()");

        /* constraints */
        G.evalProps(task, item, root, "apiso_AccessConstraints_s", "//geoSG:resourceConstraints/geoSG:MD_LegalConstraints/geoSG:useLimitation/*/text()");
        G.evalProps(task, item, root, "apiso_OtherConstraints_s", "//geoSG:resourceConstraints/geoSG:MD_LegalConstraints/geoSG:otherConstraints/*/text()");
        G.evalProps(task, item, root, "apiso_Classification_s", "//geoSG:resourceConstraints/geoSG:MD_SecurityConstraints/geoSG:MD_ClassificationCode/@codeListValue");
        G.evalProps(task, item, root, "apiso_SensitivityClassification_s", "//geoSG:resourceConstraints/geoSG:MD_SecurityConstraints/geoSG:MD_SensitivityClassification/@codeListValue");
        // G.evalProps(task, item, root, "apiso_InformationMarker_s", "//geoSG:resourceConstraints/geoSG:MD_SecurityConstraints/geoSG:MD_InformationMarker/@codeListValue");
        G.writeProp(item, "apiso_HasSecurityConstraints_b", G.hasNode(task, root, "//geoSG:resourceConstraints"));
    },
    ...
    evalSpatial: function (task) {
        ...
        G.forEachNode(task, root, "geoSG:referenceSystemInfo/geoSG:MD_ReferenceSystem/geoSG:referenceSystemIdentifier/geoSG:RS_Identifier", function (node) {
            var crsId = G.getString(task, node, "geoSG:code/*/text()");
            var crsAuth = G.getString(task, node, "gmd:authority/gmd:CI_Citation/gmd:title/*/text()");
            var crsVer = G.getString(task, node, "geoSG:version/*/text()");
    ...
    evalLinks: function (task) {
        var item = task.item,
            root = task.root;
        G.evalProp(task, item, root, "url_thumbnail_s", "geoSG:others/gmd:graphicOverview/gmd:MD_BrowseGraphic/gmd:fileName/gco:CharacterString");
        ...
        G.evalProp(task, item, root, "url_project_metadata_s", "geoSG:distributionInfo/gmd:MD_Distribution/gmd:distributor/gmd:MD_Distributor/gmd:distributorTransferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine/gmd:CI_OnlineResource[contains(gmd:name/gco:CharacterString,'Project Metadata')]/gmd:linkage/gmd:URL");
        G.evalProp(task, item, root, "url_granule_s", "geoSG:distributionInfo/gmd:MD_Distribution/gmd:distributor/gmd:MD_Distributor/gmd:distributorTransferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine/gmd:CI_OnlineResource[contains(gmd:name/gco:CharacterString,'Granule Search')]/gmd:linkage/gmd:URL");
        G.evalProp(task, item, root, "url_http_download_s", "geoSG:distributionInfo/gmd:MD_Distribution/gmd:distributor/gmd:MD_Distributor/gmd:distributorTransferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine/gmd:CI_OnlineResource/gmd:linkage/gmd:URL");
        G.evalProp(task, item, root, "url_ftp_download_s", "geoSG:distributionInfo/gmd:MD_Distribution/gmd:distributor/gmd:MD_Distributor/gmd:distributorTransferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine/gmd:CI_OnlineResource[contains(gmd:protocol/gco:CharacterString,'FTP')]/gmd:linkage/gmd:URL");
    }
